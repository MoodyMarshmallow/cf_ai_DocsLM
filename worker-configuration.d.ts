/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 15519a863c7dd02a9b78674b18df9d3b)
// Runtime types generated with workerd@1.20260128.0 2026-02-01 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/api/src/index");
		durableNamespaces: "ChatSessionDO";
	}
	interface Env {
		...
		AI: Ai;
		ENVIRONMENT: "dev";
		CHAT_SESSIONS: DurableObjectNamespace<import("./workers/api/src/index").ChatSessionDO>;
		WORKFLOWS: Workflow<Parameters<import("./workers/api/src/index").IndexProjectWorkflow['run']>[0]['payload']>;
	}
}
